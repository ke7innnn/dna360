...
const points = [
  ...
  'Quarterly refresher training and BOSS evaluation.',
]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-[80%] h-[60%] z-10 bg-white shadow-xl">
                  <Image
                    src="http://www.dna360.in/assets/img/franchise/franchise-services-01.jpg"
                    alt="Franchise Services Plan"
                    fill
                    unoptimized
                ...
                <div className="absolute bottom-0 right-0 w-[65%] h-[60%] z-20 shadow-2xl border-4 border-[#1a1a1a]">
                  <Image
                    src="http://www.dna360.in/assets/img/franchise/franchise-services-02.jpg"
                    alt="Franchise Services Gym"
                    fill
                    unoptimized
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black font-montserrat text-white mb-2">
                  Franchise <span className="text-[#00c8c8]">Services</span>
                </h2>
                ...
                <a
                  href="/DNA-360-Franchise-Services-2021.pdf"
                  download="DNA-360-Franchise-Services-2021.pdf"
                ...
                >
                  Download Franchise Services Deck
                </a>
              </motion.div>
