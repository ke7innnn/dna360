...
export default function LoginPage() {
  return (
    <div className="min-h-[100dvh] w-full flex flex-col items-center justify-center py-8 px-4 sm:p-6 lg:p-8 relative select-none overflow-y-auto pt-[max(1.5rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))]">
      ...
      <motion.div
        className="w-full max-w-[440px] z-10 space-y-4 sm:space-y-5 relative my-auto"
      ...
      >
        ...
        <div className="text-center space-y-2 flex flex-col items-center">
          <div className="relative p-2.5 sm:p-3 rounded-2xl bg-[rgba(255,255,255,0.03)] backdrop-blur-xl border border-[rgba(255,255,255,0.08)] shadow-[0_12px_32px_rgba(0,0,0,0.5)]">
            ...
            <Image
              ...
              width={160}
              height={180}
              className="h-16 sm:h-20 w-auto object-contain relative z-10 drop-shadow-[0_4px_16px_rgba(59,130,246,0.5)]"
              priority
            />
          </div>

          <p className="font-ui text-[10px] sm:text-[10.5px] uppercase tracking-[0.18em] text-[var(--accent)] font-bold pt-1">
        ...
        <Card
          className="p-5 sm:p-8 relative overflow-hidden shadow-[0_24px_60px_-15px_rgba(0,0,0,0.85)] bg-[#07090E]/80 backdrop-blur-2xl border border-[rgba(255,255,255,0.10)]"
        >
